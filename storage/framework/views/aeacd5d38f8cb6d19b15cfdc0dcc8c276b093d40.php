    ...
    <div class="main-detail w1100 fb-clearfix">
        ...
        <div class="main-right">
            <div class="mine">
                ...
                <div class="portrait">
                    <img src="<?php echo avatar($user->avatar); ?>" alt="" id="avatar">
                    <p>
                        更换头像
                ...
                <form action="" onSubmit="return update_info()" id="update_info_form">
                    <div class="name">
                        <label for="">邮箱:</label>
                        <input type="text" disabled value="<?php echo e($user->email); ?>" style="border:none">
                    </div>
                    <div class="name">
                        <label for="">昵称:</label>
...
<script>
    $(function(){
        ...
        avatar_uploader = WebUploader.create({
            ...
            swf: "<?php echo e(config('app.url')); ?>/lib/webuploader/Uploader.swf",
            chunked: true,
        ...
        avatar_uploader.on('uploadSuccess', function (file, response) {
            $("#avatar").attr('src',"<?php echo e(url('image/original/')); ?>"+response.data);
    ...
    function update_info()
    {
        ...
        if(isEmpty(name)){
            ...
            $.ajax({
                url : "<?php echo e(route('pc.user.update')); ?>",
                data : {'_token':"<?php echo csrf_token(); ?>","name":name},
                type : 'post',
                dataType : "json",
