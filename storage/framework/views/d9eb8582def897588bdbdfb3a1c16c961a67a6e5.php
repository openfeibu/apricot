        ...
        <div class="layui-col-md12">
            <div class="tabel-message">
                <div class="layui-inline tabel-btn">
                    <button class="layui-btn layui-btn-warm "><a href="<?php echo e(guard_url('page/news/create')); ?>">添加新闻动态</a></button>
...
//                ,{field:'order',title:'排序', width:80, sort: true}
        ...
        form.on('switch(lock)', function(obj){
            $.post("<?php echo e(guard_url('page/news/updateRecommend')); ?>",{"id":this.value,"home_recommend":obj.elem.checked,'_token':"<?php echo csrf_token(); ?>" },function(){
