<div class="main">
    <div class="layui-card fb-minNav">
        <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
            ...
            <a><cite><?php echo e(trans('app.edit')); ?><?php echo e(trans('page.firm.name')); ?></cite></a>
        </div>
    </div>
    <div class="main_full">
        <div class="layui-col-md12">
            ...
            <div class="fb-main-table">
                <form class="layui-form" action="<?php echo e(guard_url('page/firm/update/'.$page->id)); ?>" method="post" lay-filter="fb-form">
