                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <select name="parent_id" class="layui-select">
                                ...
                                <?php $__currentLoopData = $top_navs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $top_navs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($top_navs->id); ?>" <?php if($nav->parent_id == $top_navs->id): ?> selected <?php endif; ?>><?php echo e($top_navs->name); ?></option>
