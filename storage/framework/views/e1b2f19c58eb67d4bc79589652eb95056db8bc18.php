            ...
            <div class="fb-main-table">
                <form class="layui-form" action="<?php echo e(guard_url('admin_user')); ?>" method="post" lay-filter="fb-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="email" value="<?php echo e($admin_user->email); ?>" lay-verify="email" autocomplete="off" placeholder="请输入<?php echo e(trans("admin_user.label.email")); ?>" class="layui-input" >
                        </div>
                    </div>
