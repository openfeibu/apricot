    ...
    <div class="alert-login">
        <div class="padd30">
            <div class="alert-title">
                <p>用户登录</p>
                <div class="close"><img src="<?php echo theme_asset('images/aclose.png'); ?>" alt=""></div>
            </div>
...
<script>
    <?php if(session()->get('user_auth') === 0): ?>
    $(function(){
        $(".alertBox").fadeIn(200)
    ...
    function reg_form()
    {
        ...
        if(isEmpty(name) || isEmpty(email) || isEmpty(password)){
            ...
            $.ajax({
                url : "<?php echo e(route('pc.register')); ?>",
                data : {'_token':"<?php echo csrf_token(); ?>","name":name,"email":email,"password":password,"remember":1},
                type : 'post',
                dataType : "json",
    ...
    function login_form()
    {
        ...
        if(isEmpty(email) || isEmpty(password)){
            ...
            $.ajax({
                ...
                data : {'_token':"<?php echo csrf_token(); ?>","email":email,"password":password,"remember":1},
                type : 'post',
                dataType : "json",
                success : function (data) {
                    $fb.closeLoading();
