<div id="add-catalogue-content">
    <div class="layui-col-md12">
        <div class="fb-main-table">
            <form class="layui-form" action="{{guard_url('culture/storeCatalogue')}}" method="post" method="post" lay-filter="fb-form">
                @if($parent_catalog)
                <div class="layui-form-item">
                    <label class="layui-form-label">所属目录：</label>
                    <div class="layui-form-mid layui-word-aux">{{ $parent_catalog['title'] }}</div>
                    <div class="layui-input-inline">
                        <input type="hidden" name="parent_id" class="layui-input" value="{{ $parent_catalog['id'] }}">
                    </div>
                </div>
                @endif
                <div class="layui-form-item">
