    ...
    <div class="main_full">
        <div class="layui-col-md12">
            <div class="fb-main-table">
                <form class="layui-form" action="{{guard_url($slug)}}" method="post" method="post" lay-filter="fb-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="intro" autocomplete="off" placeholder="" class="layui-input" value="">
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    {{--<div class="layui-form-item layui-form-text">--}}
                        ...
                        {{--<div class="layui-row">--}}
                            ...
                            {{--<div class="layui-form-item">--}}
                                {{--<div class="layui-input-inline">--}}
                                    {{--<button type="button" class="layui-btn"  id="add-catalogue-btn">添加目录</button>--}}
                                {{--</div>--}}
                            {{--</div>--}}
                        {{--</div>--}}

                        {{--<div class="layui-collapse" lay-accordion="" id="catalogue">--}}
