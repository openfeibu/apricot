<div class="main">
    <div class="layui-card fb-minNav">
        <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
            ...
            <a><cite>{{ trans('app.edit') }}{{ trans('page.process_flow.name') }}</cite></a>
        </div>
    </div>
    <div class="main_full">
        <div class="layui-col-md12">
            ...
            <div class="fb-main-table">
                <form class="layui-form" action="{{guard_url('page/process_flow/update/'.$page->id)}}" method="post" lay-filter="fb-form">
